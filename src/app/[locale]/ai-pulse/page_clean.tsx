...
import { Calendar, TrendingUp, DollarSign, AlertTriangle, ArrowUp, ArrowDown, BarChart3, Activity, Eye, EyeOff, RefreshCw, Zap, Users, PieChart } from 'lucide-react';
import ProtectedRoute from '@/components/ProtectedRoute';
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, LineChart, Line, PieChart as RechartsPieChart, Cell, ComposedChart, Area, AreaChart } from 'recharts';
...
interface ETFComparison {
  pair: ComparisonPair;
  etf1Data: ETFData | null;
  etf2Data: ETFData | null;
}
...
const COMPARISON_PAIRS: ComparisonPair[] = [
  ...
  { id: 'vti-vtiax', name: 'VTI vs VXUS', etf1: 'VTI', etf2: 'VXUS' },
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      ...
                      {currentComparison.etf1Data.expenseRatio && currentComparison.etf2Data.expenseRatio && (
                        <tr className="border-b border-gray-800">
                          <td className="py-3 px-4 text-gray-400">Expense Ratio</td>
                          <td className="py-3 px-4 text-white">{currentComparison.etf1Data.expenseRatio.toFixed(2)}%</td>
                          <td className="py-3 px-4 text-white">{currentComparison.etf2Data.expenseRatio.toFixed(2)}%</td>
                        </tr>
                      )}
                    </tbody>
                  </table>
