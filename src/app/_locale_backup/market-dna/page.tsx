        ...
        <header className="sticky top-0 z-30 bg-[#060a13]/80 backdrop-blur-xl border-b border-white/[0.04]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <NavigationLink href="/market-extremes"
                className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] text-xs font-semibold text-gray-300 hover:text-white transition-all">
                <span>🔥</span> Market Extremes
              </NavigationLink>
