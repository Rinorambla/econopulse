 ...
 *
 * NOTE: This route is intentionally named "billing" (not "stripe") because many
 * ad-blockers / privacy shields block any URL containing the word "stripe",
 * which would cause a client-side "Failed to fetch" before the request is sent.
 *
