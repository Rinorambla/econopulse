...
// Direct page component (removed indirection to _locale_backup) to ensure stable prerender.
			...
			<div className="max-w-4xl mx-auto px-4 py-12">
				<div className="bg-white rounded-lg shadow-lg p-8">
					<div className="mb-8">
						...
						<p className="text-gray-600">Last updated: August 22, 2025</p>
					</div>
					<div className="prose max-w-none">
						<section className="mb-8">
							...
							<p className="text-gray-700 mb-4">
								Cookies are small text files that are stored on your computer or mobile device when you visit a website. They help websites
								remember information about your visit, making it easier to visit the site again and make the site more useful to you.
							</p>
						</section>
						<section className="mb-8">
							<h2 className="text-2xl font-semibold text-gray-900 mb-4">How We Use Cookies</h2>
							<p className="text-gray-700 mb-4">We use cookies and similar technologies for several purposes:</p>
						...
						<section className="mb-8">
							...
							<div className="space-y-6">
								<div className="bg-green-50 border border-green-200 rounded-lg p-6">
									...
									<p className="text-gray-700 mb-3">These cookies are essential for the website to function properly and cannot be disabled.</p>
								...
								<div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
									...
									<div className="text-sm text-gray-600">
										...
										<p><strong>Examples:</strong> Page views, user behavior</p>
									</div>
								</div>
								<div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
									<div className="flex items-center gap-3 mb-3">
										...
										<span className="bg-purple-100 text-purple-800 text-xs px-2 py-1 rounded">Optional</span>
									</div>
									<p className="text-gray-700 mb-3">These cookies are used to deliver personalized advertisements and track their effectiveness.</p>
									<div className="text-sm text-gray-600">
								...
								<div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
									<div className="flex items-center gap-3 mb-3">
										...
										<span className="bg-yellow-100 text-yellow-800 text-xs px-2 py-1 rounded">Optional</span>
									</div>
									<p className="text-gray-700 mb-3">These cookies enable enhanced functionality and personalization features.</p>
									<div className="text-sm text-gray-600">
						...
						<section className="mb-8">
							...
							<p className="text-gray-700 mb-4">You can manage your cookie preferences in several ways:</p>
							<div className="bg-gray-50 p-6 rounded-lg mb-4">
								<h3 className="text-lg font-semibold text-gray-900 mb-3">Cookie Banner</h3>
								<p className="text-gray-700 mb-3">When you first visit our website, you'll see a cookie banner where you can:</p>
								<ul className="list-disc pl-6 text-gray-700">
							...
							<div className="bg-gray-50 p-6 rounded-lg mb-4">
								...
								<p className="text-gray-700 mb-3">You can change your preferences at any time by clicking the "Cookie Settings" link in our website footer.</p>
							</div>
							<div className="bg-gray-50 p-6 rounded-lg">
								<h3 className="text-lg font-semibold text-gray-900 mb-3">Browser Settings</h3>
								<p className="text-gray-700 mb-3">Most web browsers allow you to control cookies through their settings:</p>
								<ul className="list-disc pl-6 text-gray-700">
						...
						<section className="mb-8">
							...
							<p className="text-gray-700 mb-4">Some cookies on our site are set by third-party services we use:</p>
							<ul className="list-disc pl-6 text-gray-700">
						...
						<section className="mb-8">
							...
							<p className="text-gray-700">Our website respects Do Not Track (DNT) signals. When DNT is enabled in your browser, we will not set optional cookies or load third-party tracking services.</p>
						</section>
						<section className="mb-8">
							<h2 className="text-2xl font-semibold text-gray-900 mb-4">Updates to This Policy</h2>
							<p className="text-gray-700">We may update this Cookie Policy from time to time to reflect changes in our practices or applicable laws. We will post any updates on this page and update the effective date.</p>
						</section>
						<section className="mb-8">
