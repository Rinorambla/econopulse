...
// Lazy-load particle layer to avoid any import-time errors impacting the main UI
const MarketParticles = React.lazy(() => import('./MarketParticles'));
...
export default function AIBackground({ className = '', intensity = 'default' }: AIBackgroundProps) {
  try {
    ...
    // Soft-fail: if anything goes wrong, do not break the page layout
